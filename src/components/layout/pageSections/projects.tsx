...
export const MyProjects = () => (
  <section
    id="myProjects"
    className="w-full flex flex-col gap-5 md:gap-10 h-full items-center min-h-[calc(100vh-10rem)]"
  >
    <div className="flex items-center flex-col gap-2.5 text-center">
      <Badge className="md:text-lg font-semibold">Project showcase</Badge>
      <div>
